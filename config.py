...
OPENAI_API = getenv("OPENAI_API", "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")
OPENAI_API_KEY = getenv("OPENAI_API_KEY", "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")
