...
OPENAI_API = getenv("OPENAI_API", "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")
OPENAI_API_KEY = getenv("OPENAI_API_KEY", "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")
